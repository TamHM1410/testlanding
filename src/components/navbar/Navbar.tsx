  ...
  return (
    <>
      <div className="text-white min-w-sreen max-h-[80px] bg-navCor">
        ...
        <nav
          className="lg:mx-[10%] flex  items-center justify-between p-6 lg:px-8 lg:max-w-[1440px] w-full"
          aria-label="Global"
        >
          <div className="flex lg:flex-1 text-white flex-row gap-1 ">
            <a href="#" className="-m-1.5 p-1.5">
              <Image src={logo} alt="Tok" width={40} height={40} className="rounded-full" />
            </a>
