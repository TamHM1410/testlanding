...
export default function () {
  return (
    <>
      <div className="py-10 mx-[10%] text-white  2xl:text-2xl 2xl:mx-[10%] overflow-x-scroll no-scrollbar ">
        <div className="flex justify-center ">
          <div className="flex grid lg:grid-cols-2 gap-52 max-w-[1440px] max-sm:gap-10 max-lg:gap-10 ">
            ...
            >
              ...
              <div className="text-customGrey lg:hidden">
                {Content.upgrade.des}
              </div>

              <div className="text-customGrey max-lg:hidden w-full text-lg flex flex-wrap">
                {Content.upgrade.des_a}
              </div>
              <div className="text-customGrey max-lg:hidden w-full text-lg">
