    ...
    <>
        ...
        <div className="flex justify-center">
          ...
          {Content.privacy.privacy.map((item, index) => {
            return (
              <>
                <div key={index} className=" max-sm:text-[14px] sm:text-[16px] lg:text-[18px] duration-100">{item.title}</div>
                {item?.des.map((item) => {
                  return (
                    <>
                      <div key={item} className=" py-3    max-sm:text-[14px] lg:text-[18px] max-sm:text-[14px] sm:text-[16px] lg:text-[18px] leading-[34px] max-sm:leading-[22px] duration-100">{item}</div>
                    </>
                  );
                })}
              </>
        ...
        <div className="flex justify-center pt- text-center max-sm:text-sm max-[500px]:px-5 min-[500px]:px-[80px] lg:text-[18px] sm:text-[16px] max-sm:text-[14px]">
