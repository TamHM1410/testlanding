    ...
    <>
      ...
      <div className=" max-h-max	2xl:text-2xl  pt-10 px-10 text-white flex justify-center items-center md:hidden flex-col min-w-screen  max-w-[1440px]">
        ...
        <div className=" pt-5 mt-10 flex flex-col ">
          ...
          <div className="mx-[5%]">
            <div className="carousel w-full " onScroll={(event) => handleScroll(event)}>
          ...
          <div
            ...
            style={{ color: "#817DA0" }}
          >
            Đừng bỏ lỡ cơ hội trò chuyện. Hãy nhắn tin với người ấy khi cảm thấy hợp gout nhé!      
          </div>
          </div>
          <div className="carousel-item flex flex-col  w-full">
          <div className=" flex  justify-center">
          ...
          <div className="flex justify-center mt-2 carousel">
            <span className="mx-5 gap-1 flex flex-row w-[38px] h-[6px] justify-center">
              <div
                ...
                style={{
                  backgroundColor: scrollPosition < 294 ? "#A11BC7" : "#1D1E3C",
              ...
              <div
                ...
                style={{
                  backgroundColor:
                    scrollPosition > 294 && scrollPosition < 589
                      ? "#A11BC7"
                      : "#1D1E3C",
                  width: scrollPosition > 294 && scrollPosition < 589 ? 24 : 12,
                }}
              ></div>
              <div
                className="h-full duration-100  rounded"
                ...
                style={{
                  backgroundColor:
                    scrollPosition > 590 && scrollPosition <885 ? "#A11BC7" : "#1D1E3C",
                  width:  scrollPosition > 590 && scrollPosition <885  ? 24 : 12,
                }}
              ></div>
               <div
                className="h-full duration-100  rounded"
                ...
                style={{
                  backgroundColor:
                    scrollPosition > 885 ? "#A11BC7" : "#1D1E3C",
                  width: scrollPosition > 885 ? 24 : 12,
                }}
              ></div>
            </span>
          </div>
      ...
      <div className="min-w-screen max-w-screen py-5 flex justify-center">
      <div className="py-5 mx-[10%] grid grid-cols-3 max-lg:grid-cols-2  h-[657px] max-sm:hidden max-md:hidden max-w-[1440px]">
        <div className=" p-2 grid grid-rows-4 text-white max-lg:p-6">
          <div className="row-span-2 flex flex-col my-10">
            ...
            <div className="py-2 text-xl font-bold flex ">Chi tiết profile</div>
        ...
        <div className=" p-8  max-lg:hidden">
          <Image width={550} height={657} src={group_1} alt="" key={0}  className="max-lg:none"/>
        </div>
        <div className="p-2 grid grid-rows-4 text-white max-lg:p-6">
